...
class BatchFileMakerWindow:
    ...
    def show(self):
        ...
        if cmds.formLayout(self._mainForm, nd=100):
            ...
            cmds.formLayout(
                self._fl_form,
                e=True,
                af=[(self._fl_list, "left", 0), (self._fl_list, "right", 0), (self._fl_list, "top", 0)],
                ac=[(self._fl_list, "bottom", 2, self._fl_addBtn)],
            )
            cmds.formLayout(
                self._fl_form,
                e=True,
                af=[
                    (self._fl_addBtn, "bottom", 8),
                    (self._fl_loadBtn, "bottom", 8),
                    (self._fl_remBtn, "bottom", 8),
                    (self._fl_clearBtn, "bottom", 8),
                ],
            )
            cmds.formLayout(
                self._fl_form, e=True, ap=[(self._fl_addBtn, "left", 4, 0), (self._fl_addBtn, "right", 2, 25)]
            )
            cmds.formLayout(
                self._fl_form, e=True, ap=[(self._fl_loadBtn, "left", 4, 25), (self._fl_loadBtn, "right", 2, 50)]
            )
            cmds.formLayout(
                self._fl_form, e=True, ap=[(self._fl_remBtn, "left", 4, 50), (self._fl_remBtn, "right", 2, 75)]
            )
            cmds.formLayout(
                self._fl_form, e=True, ap=[(self._fl_clearBtn, "left", 4, 75), (self._fl_clearBtn, "right", 2, 100)]
            )
            ...
            if cmds.frameLayout(self._rs_frame, l="Render Settings", bs="etchedOut", li=10, height=self._frameHeights):
                if cmds.popupMenu(self._rs_popup, mm=True):
                    ...
                    cmds.menuItem(
                        self._rs_mm_range, l="Frame Range", cb=checkList[0], c=self.rs_updateRenderSettingsDisplay
                    )
                    cmds.menuItem(self._rs_mm_pad, l="Padding", cb=checkList[1], c=self.rs_updateRenderSettingsDisplay)
                    cmds.menuItem(
                        self._rs_mm_res, l="Resolution", cb=checkList[2], c=self.rs_updateRenderSettingsDisplay
                    )
                    cmds.menuItem(
                        self._rs_mm_fnc, l="File Naming Format", cb=checkList[3], c=self.rs_updateRenderSettingsDisplay
                    )
                    cmds.menuItem(
                        self._rs_mm_of, l="Output Format", cb=checkList[4], c=self.rs_updateRenderSettingsDisplay
                    )
                    ...
                    cmds.menuItem(
                        self._rs_mm_rd, l="Render Directory", cb=checkList[7], c=self.rs_updateRenderSettingsDisplay
                    )
                ...
                if cmds.formLayout(self._rs_form, nd=100):
                    ...
                    cmds.formLayout(
                        self._rs_form,
                        e=True,
                        ap=[(self._rs_noOptsText, "left", -75, 50), (self._rs_noOptsText, "top", -20, 50)],
                    )
                    # frame range
                    ...
                    cmds.formLayout(
                        ...
                        e=True,
                        ac=[
                            (self._rs_rangeText1, "right", 2, self._rs_start),
                            (self._rs_rangeText2, "left", 2, self._rs_start),
                            (self._rs_end, "left", 2, self._rs_rangeText2),
                        ],
                    )
                    cmds.formLayout(
                        self._rs_form,
                        e=True,
                        ap=[
                            (self._rs_rangeText1, "top", 8, 0),
                            (self._rs_start, "top", 6, 0),
                            (self._rs_rangeText2, "top", 8, 0),
                            (self._rs_end, "top", 6, 0),
                        ],
                    )
                    # get frame range
                    cmds.formLayout(self._rs_form, e=True, ap=[(self._rs_getRangeBtn, "left", self._rs_centerLine, 50)])
                    cmds.formLayout(
                        self._rs_form, e=True, ac=[(self._rs_getRangeText, "left", 4, self._rs_getRangeBtn)]
                    )
                    cmds.formLayout(
                        self._rs_form,
                        e=True,
                        ac=[
                            (self._rs_getRangeText, "top", 5, self._rs_start),
                            (self._rs_getRangeBtn, "top", 2, self._rs_start),
                        ],
                    )
                    # padding
                    ...
                    cmds.formLayout(
                        ...
                        e=True,
                        ac=[
                            (self._rs_padText, "top", 8, self._rs_getRangeBtn),
                            (self._rs_pad, "top", 6, self._rs_getRangeBtn),
                        ],
                    )
                    # resolution
                    ...
                    cmds.formLayout(
                        self._rs_form,
                        e=True,
                        ac=[(self._rs_resText, "right", 2, self._rs_resW), (self._rs_resH, "left", 2, self._rs_resW)],
                    )
                    cmds.formLayout(
                        self._rs_form,
                        e=True,
                        ac=[
                            (self._rs_resText, "top", 8, self._rs_pad),
                            (self._rs_resW, "top", 6, self._rs_pad),
                            (self._rs_resH, "top", 6, self._rs_pad),
                        ],
                    )
                    ...
                    cmds.formLayout(
                        self._rs_form,
                        e=True,
                        ac=[(self._rs_fncOpt, "top", 6, self._rs_resW), (self._rs_fncText, "top", 8, self._rs_resW)],
                    )
                    # output format
                    ...
                    cmds.formLayout(
                        self._rs_form,
                        e=True,
                        ac=[(self._rs_ofOpt, "top", 6, self._rs_fncOpt), (self._rs_ofText, "top", 8, self._rs_fncOpt)],
                    )
                    # renderer
                    ...
                    cmds.formLayout(
                        self._rs_form,
                        e=True,
                        ac=[(self._rs_rOpt, "top", 6, self._rs_ofOpt), (self._rs_rText, "top", 8, self._rs_ofOpt)],
                    )
                    # project text
                    ...
                    cmds.formLayout(
                        self._rs_form,
                        e=True,
                        ap=[(self._rs_pdField, "left", 4, 0)],
                        ac=[(self._rs_pdField, "right", 2, self._rs_pdBtn)],
                    )
                    ...
                    cmds.formLayout(
                        ...
                        e=True,
                        ac=[
                            (self._rs_pdField, "bottom", 3, self._rs_rdText),
                            (self._rs_pdBtn, "bottom", 3, self._rs_rdText),
                        ],
                    )
                    ...
                    cmds.formLayout(
                        self._rs_form,
                        e=True,
                        ap=[(self._rs_rdField, "left", 4, 0)],
                        ac=[(self._rs_rdField, "right", 2, self._rs_rdBtn)],
                    )
                    cmds.formLayout(self._rs_form, e=True, af=[(self._rs_rdBtn, "right", 6)])
                    cmds.formLayout(
                        self._rs_form,
                        e=True,
                        ap=[(self._rs_rdField, "bottom", 4, 100), (self._rs_rdBtn, "bottom", 4, 100)],
                    )
            ...
            if cmds.frameLayout(
                self._bfs_frame, l="Batch File Settings", bs="etchedOut", li=10, height=self._frameHeights
            ):
                if cmds.formLayout(self._bfs_form, nd=100):
                    ...
                    cmds.formLayout(
                        self._bfs_form,
                        e=True,
                        ap=[(self._bfs_nameText, "left", 8, 0), (self._bfs_nameText, "top", 8, 0)],
                    )
                    # prefix
                    ...
                    cmds.formLayout(
                        self._bfs_form,
                        e=True,
                        ac=[(self._bfs_prefixField, "left", 6, self._bfs_prefixText)],
                        ap=[(self._bfs_prefixField, "right", 12, 100)],
                    )
                    cmds.formLayout(
                        self._bfs_form,
                        e=True,
                        ac=[
                            (self._bfs_prefixText, "top", 8, self._bfs_nameText),
                            (self._bfs_prefixField, "top", 6, self._bfs_nameText),
                        ],
                    )
                    # scene
                    ...
                    cmds.formLayout(
                        ...
                        e=True,
                        ac=[
                            (self._bfs_rangeCheck, "left", 3, self._bfs_sceneCheck),
                            (self._bfs_numberedCheck, "left", 3, self._bfs_rangeCheck),
                        ],
                    )
                    cmds.formLayout(
                        self._bfs_form,
                        e=True,
                        ac=[
                            (self._bfs_sceneCheck, "top", 4, self._bfs_prefixField),
                            (self._bfs_rangeCheck, "top", 4, self._bfs_prefixField),
                            (self._bfs_numberedCheck, "top", 4, self._bfs_prefixField),
                        ],
                    )
                    # preview
                    cmds.formLayout(
                        self._bfs_form,
                        e=True,
                        ap=[(self._bfs_previewText, "left", 12, 0), (self._bfs_previewText, "right", 12, 100)],
                        ac=[(self._bfs_previewText, "top", 6, self._bfs_numberedCheck)],
                    )
                    # sep1
                    cmds.formLayout(
                        self._bfs_form,
                        e=True,
                        ap=[(self._bfs_sep1, "left", 12, 0), (self._bfs_sep1, "right", 12, 100)],
                        ac=[(self._bfs_sep1, "top", 8, self._bfs_previewText)],
                    )
                    # divisions
                    ...
                    cmds.formLayout(
                        ...
                        e=True,
                        ac=[
                            (self._bfs_divText, "top", 8, self._bfs_sep1),
                            (self._bfs_divField, "top", 6, self._bfs_sep1),
                        ],
                    )
                    # divisions help
                    cmds.formLayout(
                        self._bfs_form,
                        e=True,
                        ap=[(self._bfs_divText2, "left", -105, 50)],
                        ac=[(self._bfs_divText2, "top", 3, self._bfs_divField)],
                    )
                    # sep2
                    cmds.formLayout(
                        self._bfs_form,
                        e=True,
                        ap=[(self._bfs_sep2, "left", 12, 0), (self._bfs_sep2, "right", 12, 100)],
                        ac=[(self._bfs_sep2, "top", 8, self._bfs_previewText)],
                    )
                    # save location text
                    cmds.formLayout(
                        self._bfs_form,
                        e=True,
                        ap=[(self._bfs_saveText, "left", 8, 0)],
                        ac=[(self._bfs_saveText, "bottom", 3, self._bfs_saveField)],
                    )
                    # save location field
                    cmds.formLayout(
                        self._bfs_form,
                        e=True,
                        ap=[(self._bfs_saveField, "left", 4, 0)],
                        ac=[(self._bfs_saveField, "right", 2, self._bfs_saveBtn)],
                    )
                    cmds.formLayout(self._bfs_form, e=True, af=[(self._bfs_saveBtn, "right", 6)])
                    cmds.formLayout(
                        self._bfs_form,
                        e=True,
                        ap=[(self._bfs_saveField, "bottom", 4, 100), (self._bfs_saveBtn, "bottom", 4, 100)],
                    )
        ...
        cmds.formLayout(
            self._mainForm,
            e=True,
            af=[(self._fl_form, "left", 4), (self._fl_form, "right", 4), (self._fl_form, "top", 4)],
            ac=[(self._fl_form, "bottom", 6, self._bfs_frame)],
        )
        cmds.formLayout(
            self._mainForm,
            e=True,
            af=[(self._rs_frame, "left", 4)],
            ap=[(self._rs_frame, "right", 2, 50)],
            ac=[(self._rs_frame, "bottom", 4, self._makeBtn)],
        )
        cmds.formLayout(
            self._mainForm,
            e=True,
            af=[(self._bfs_frame, "right", 4)],
            ap=[(self._bfs_frame, "left", 2, 50)],
            ac=[(self._bfs_frame, "bottom", 4, self._makeBtn)],
        )
        cmds.formLayout(
            self._mainForm,
            e=True,
            af=[(self._makeBtn, "left", 4), (self._makeBtn, "right", 4), (self._makeBtn, "bottom", 4)],
        )
    ...
    def updateMakeButton(self):
        ...
        if selList:
            ...
            cmds.button(
                self._makeBtn,
                e=True,
                l="Make Batch File%s (%d file%s selected)" % (countPlural, count, countPlural),
                en=True,
            )
        else:
    ...
    def getBatchFileSettings(self):
        ...
        return {
            "prefix": prefix,
            "includeScene": sceneCheck,
            "includeRange": frCheck,
            "includeNum": numCheck,
            "div": div,
            "sd": save,
        }
    ...
    def checkPaths(self):
        ...
        if self.bfs["sd"]:
            if not os.path.exists(self.bfs["sd"]):
                result = cmds.confirmDialog(
                    ...
                    m="The specified Save Location does not exist, create?\n%s" % self.bfs["sd"],
                    b=["Yes", "No"],
                    db="Ok",
                    cb="No",
                )
            ...
            result = cmds.confirmDialog(
                t="Save Location",
                ma="center",
                m="No save location was specified for the batch files.\nThey will be saved to the last working directory.\nDo you want to continue?",
                b=["Yes", "No"],
                db="Ok",
                cb="No",
            )
            if result == "Yes":
                pyWarning(
                    "no save location specified: batch files will be saved to the last working directory, check script editor for details"
                )
            else:
        ...
        if self.rs["pd"]:
            if not os.path.exists(self.rs["pd"]):
                result = cmds.confirmDialog(
                    t="Creating Directory...",
                    m="The specified Project Directory does not exist, create?\n%s" % self.rs["pd"],
                    b=["Yes", "No"],
                    db="Ok",
                    cb="No",
                )
        ...
        if self.rs["rd"]:
            if not os.path.exists(self.rs["rd"]):
                result = cmds.confirmDialog(
                    t="Creating Directory...",
                    m="The specified Render Directory does not exist, create?\n%s" % self.rs["rd"],
                    b=["Yes", "No"],
                    db="Ok",
                    cb="No",
                )
